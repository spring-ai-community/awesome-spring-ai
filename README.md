...
- [mcp-java-testkit](https://github.com/senor14/mcp-java-testkit) - JUnit 5 toolkit for testing MCP servers: conformance assertions across tools, resources and prompts, contract snapshots, and token-budget CI gates. Tests Spring AI MCP servers in-process with automatic `@SpringBootTest` random-port discovery, over stdio or Streamable HTTP.
