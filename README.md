...
- [Spring AI FlowSpeech](https://github.com/waeckerlinfederowicz66-sketch/spring-ai-flowspeech) - A Spring AI Text-to-Speech provider and Spring Boot starter for [FlowSpeech](https://flowspeech.io/). Includes typed options, auto-configuration, tests, and a runnable demo application.
