...
- [Spring AI FlowSpeech](https://github.com/waeckerlinfederowicz66-sketch/spring-ai-flowspeech) - A Spring AI Text-to-Speech provider and Spring Boot starter for [FlowSpeech](https://flowspeech.io/). Includes a `TextToSpeechModel` implementation, auto-configuration, starter module, tests, and a runnable demo.
